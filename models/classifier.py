...
class SpikingClassifier(nn.Module):
    """Compact fully spiking classifier for image or feature-map streams."""

    def __init__(self, input_channels=1, num_classes=10, n_steps=16, img_size=32):
        super().__init__()
        self.n_steps = n_steps
        pooled_size = max(1, img_size // 4)
